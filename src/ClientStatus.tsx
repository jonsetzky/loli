...
export const ClientStatus = () => {
  ...
  return (
    <FullscreenNotification>
      <div className="flex flex-col gap-2 divide-y-[0.1px] divide-slate-700 h-full">
        <h1 className="text-3xl font-light tracking-wider">Client offline</h1>

        <div className="grow pt-4 text-slate-400 text-sm font-light tracking-wide h-full flex flex-col">
          <div className="grid grid-cols-2">
            <div className="col-span-2">Client appears to be offline</div>
            <div className="col-span-2 text-xs text-slate-500">{"-"}</div>
          </div>
          <div className="grow" />
          <div className="flex flex-row justify-center divide-slate-700 divide-x-[0.1px]">
            <button
              className="rounded-sm text-white uppercase pr-2 hover:text-glow text-xl"
              onClick={() => {
            ...
            <button className="rounded-sm text-white uppercase pl-2 hover:text-glow text-xl">
              quit
            </button>
          </div>
        </div>
